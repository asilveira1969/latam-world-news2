...
globalThis.fetch = (async (input: RequestInfo | URL) => {
  ...
  return new Response(`<?xml version="1.0"?><rss><channel><item><title>Noticia ${id} sobre energía internacional</title><link>https://example.test/${id}</link><pubDate>2026-08-30T10:00:00.000Z</pubDate><description><![CDATA[${longHtml}]]></description><content:encoded><![CDATA[${"CUERPO COMPLETO ".repeat(100)}]]></content:encoded></item></channel></rss>`, { status: 200, headers: { "content-type": "application/rss+xml" } });
}) as typeof fetch;
