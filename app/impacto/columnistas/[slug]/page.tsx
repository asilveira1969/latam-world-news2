...
export async function generateMetadata({ params }: ColumnistDetailPageProps): Promise<Metadata> {
  const resolvedParams = await params;
  const article = await getArticleBySlug(resolvedParams.slug, "impacto-columnista");
...
export default async function ColumnistDetailPage({ params }: ColumnistDetailPageProps) {
  const resolvedParams = await params;
  const article = await getArticleBySlug(resolvedParams.slug, "impacto-columnista");
